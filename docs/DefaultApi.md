...
> api_v1_blueprints_blueprint_id_delete(blueprint_id)
...
> object api_v1_blueprints_blueprint_id_patch(blueprint_id, name, description, enrollment_code_code, enrollment_code_is_active)
...
> object api_v1_blueprints_blueprint_id_remove_library_item_post(blueprint_id, body=body)
...
> api_v1_devices_device_id_action_playlostmodesound_post(device_id)
...
> api_v1_devices_device_id_action_setname_post(device_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Set Name
        api_instance.api_v1_devices_device_id_action_setname_post(device_id, body=body)
    except Exception as e:
...
# **api_v1_devices_device_id_commands_get**
> api_v1_devices_device_id_commands_get(device_id, limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Device Commands
        api_instance.api_v1_devices_device_id_commands_get(device_id, limit, offset=offset)
    except Exception as e:
        print("Exception when calling DefaultApi->api_v1_devices_device_id_commands_get: %s\n" % e)
```
...
> api_v1_devices_device_id_delete(device_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Device
        api_instance.api_v1_devices_device_id_delete(device_id)
    except Exception as e:
...
> object api_v1_devices_device_id_notes_note_id_patch(device_id, note_id, authorization, content_type, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Device Note
        api_response = api_instance.api_v1_devices_device_id_notes_note_id_patch(device_id, note_id, authorization, content_type, body=body)
...
> object api_v1_devices_device_id_notes_post(device_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Device Note
        api_response = api_instance.api_v1_devices_device_id_notes_post(device_id, body=body)
...
> object api_v1_devices_device_id_patch(device_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Device
        api_response = api_instance.api_v1_devices_device_id_patch(device_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Devices
        api_response = api_instance.api_v1_devices_get(limit, asset_tag=asset_tag, blueprint_id=blueprint_id, device_id=device_id, device_name=device_name, filevault_enabled=filevault_enabled, mac_address=mac_address, model=model, ordering=ordering, os_version=os_version, platform=platform, serial_number=serial_number, tag_name=tag_name, tag_name_in=tag_name_in, tag_id=tag_id, tag_id_in=tag_id_in, user=user, user_email=user_email, user_id=user_id, user_name=user_name, offset=offset)
        print("The response of DefaultApi->api_v1_devices_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->api_v1_devices_get: %s\n" % e)
```
...
> api_v1_integrations_apple_ade_ade_token_id_delete(ade_token_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete ADE integration
        api_instance.api_v1_integrations_apple_ade_ade_token_id_delete(ade_token_id)
    except Exception as e:
...
> object api_v1_integrations_apple_ade_ade_token_id_devices_get(ade_token_id, page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List devices associated to ADE token
        api_response = api_instance.api_v1_integrations_apple_ade_ade_token_id_devices_get(ade_token_id, page=page)
...
> api_v1_integrations_apple_ade_ade_token_id_get(ade_token_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get ADE integration
        api_instance.api_v1_integrations_apple_ade_ade_token_id_get(ade_token_id)
    except Exception as e:
...
> api_v1_integrations_apple_ade_ade_token_id_patch(ade_token_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update ADE integration
        api_instance.api_v1_integrations_apple_ade_ade_token_id_patch(ade_token_id, body=body)
    except Exception as e:
...
> api_v1_integrations_apple_ade_ade_token_id_renew_post(ade_token_id, blueprint_id, phone, email, file)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Renew ADE integration
        api_instance.api_v1_integrations_apple_ade_ade_token_id_renew_post(ade_token_id, blueprint_id, phone, email, file)
    except Exception as e:
...
> object api_v1_integrations_apple_ade_devices_device_id_patch(device_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update ADE device
        api_response = api_instance.api_v1_integrations_apple_ade_devices_device_id_patch(device_id, body=body)
...
> object api_v1_integrations_apple_ade_devices_get(blueprint_id=blueprint_id, user_id=user_id, dep_account=dep_account, device_family=device_family, model=model, os=os, profile_status=profile_status, serial_number=serial_number, page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List ADE devices
        api_response = api_instance.api_v1_integrations_apple_ade_devices_get(blueprint_id=blueprint_id, user_id=user_id, dep_account=dep_account, device_family=device_family, model=model, os=os, profile_status=profile_status, serial_number=serial_number, page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List ADE integrations
        api_instance.api_v1_integrations_apple_ade_get()
    except Exception as e:
...
> object api_v1_integrations_apple_ade_post(blueprint_id, phone, email, file)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create ADE integration
        api_response = api_instance.api_v1_integrations_apple_ade_post(blueprint_id, phone, email, file)
...
> str api_v1_integrations_apple_ade_public_key_get()
...
> object api_v1_library_custom_apps_get(page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Custom Apps
        api_response = api_instance.api_v1_library_custom_apps_get(page=page)
...
> api_v1_library_custom_apps_library_item_id_delete(library_item_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Custom App
        api_instance.api_v1_library_custom_apps_library_item_id_delete(library_item_id)
    except Exception as e:
...
> object api_v1_library_custom_apps_library_item_id_patch(library_item_id, name, active)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Custom App
        api_response = api_instance.api_v1_library_custom_apps_library_item_id_patch(library_item_id, name, active)
...
> object api_v1_library_custom_apps_post(name, file_key, install_type, install_enforcement, show_in_self_service, self_service_category_id, self_service_recommended)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Custom App
        api_response = api_instance.api_v1_library_custom_apps_post(name, file_key, install_type, install_enforcement, show_in_self_service, self_service_category_id, self_service_recommended)
...
> api_v1_library_custom_apps_upload_post(body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Upload Custom App
        api_instance.api_v1_library_custom_apps_upload_post(body=body)
    except Exception as e:
...
> object api_v1_library_custom_profiles_get(page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Custom Profiles
        api_response = api_instance.api_v1_library_custom_profiles_get(page=page)
...
> api_v1_library_custom_profiles_library_item_id_delete(library_item_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Custom Profile
        api_instance.api_v1_library_custom_profiles_library_item_id_delete(library_item_id)
    except Exception as e:
...
> object api_v1_library_custom_profiles_library_item_id_patch(library_item_id, runs_on_mac=runs_on_mac, runs_on_iphone=runs_on_iphone, runs_on_ipad=runs_on_ipad, runs_on_tv=runs_on_tv)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    runs_on_ipad = 'false' # str |  (optional)
    runs_on_tv = 'false' # str |  (optional)

    try:
        # Update Custom Profile
        api_response = api_instance.api_v1_library_custom_profiles_library_item_id_patch(library_item_id, runs_on_mac=runs_on_mac, runs_on_iphone=runs_on_iphone, runs_on_ipad=runs_on_ipad, runs_on_tv=runs_on_tv)
...
------------- | ------------- | ------------- | -------------
 **library_item_id** | **str**|  | 
 **runs_on_mac** | **str**|  | [optional] 
 **runs_on_iphone** | **str**|  | [optional] 
 **runs_on_ipad** | **str**|  | [optional] 
 **runs_on_tv** | **str**|  | [optional] 
...
> object api_v1_library_custom_profiles_post(name, file, active, runs_on_mac=runs_on_mac, runs_on_iphone=runs_on_iphone, runs_on_ipad=runs_on_ipad, runs_on_tv=runs_on_tv)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Custom Profile
        api_response = api_instance.api_v1_library_custom_profiles_post(name, file, active, runs_on_mac=runs_on_mac, runs_on_iphone=runs_on_iphone, runs_on_ipad=runs_on_ipad, runs_on_tv=runs_on_tv)
...
> object api_v1_library_custom_scripts_get(page=page)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Custom Scripts
        api_response = api_instance.api_v1_library_custom_scripts_get(page=page)
...
> api_v1_library_custom_scripts_library_item_id_delete(library_item_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Custom Script
        api_instance.api_v1_library_custom_scripts_library_item_id_delete(library_item_id)
    except Exception as e:
...
> object api_v1_library_custom_scripts_library_item_id_patch(library_item_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Custom Script
        api_response = api_instance.api_v1_library_custom_scripts_library_item_id_patch(library_item_id, body=body)
...
> object api_v1_library_custom_scripts_post(body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Custom Script
        api_response = api_instance.api_v1_library_custom_scripts_post(body=body)
...
> object api_v1_library_library_items_library_item_id_activity_get(library_item_id, activity_type=activity_type, user_id=user_id, user_email=user_email, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Library Item Activity
        api_response = api_instance.api_v1_library_library_items_library_item_id_activity_get(library_item_id, activity_type=activity_type, user_id=user_id, user_email=user_email, limit=limit, offset=offset)
...
> object api_v1_library_library_items_library_item_id_status_get(library_item_id, computer_id=computer_id, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Library Item Statuses
        api_response = api_instance.api_v1_library_library_items_library_item_id_status_get(library_item_id, computer_id=computer_id, limit=limit, offset=offset)
...
> api_v1_prism_activation_lock_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Activation lock
        api_instance.api_v1_prism_activation_lock_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **blueprint_ids** | **str**|  | [optional] 
 **device_families** | **str**|  | [optional] 
 **filter** | **str**|  | [optional] 
 **sort_by** | **str**|  | [optional] 
 **limit** | **str**|  | [optional] 
 **offset** | **str**|  | [optional] 
...
> object api_v1_prism_application_firewall_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Application firewall
        api_response = api_instance.api_v1_prism_application_firewall_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_apps_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Applications
        api_response = api_instance.api_v1_prism_apps_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_certificates_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Certificates
        api_response = api_instance.api_v1_prism_certificates_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
# **api_v1_prism_count_get**
> object api_v1_prism_count_get(category)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Count
        api_response = api_instance.api_v1_prism_count_get(category)
        print("The response of DefaultApi->api_v1_prism_count_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->api_v1_prism_count_get: %s\n" % e)
```
...
> object api_v1_prism_desktop_and_screensaver_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Desktop and Screensaver
        api_response = api_instance.api_v1_prism_desktop_and_screensaver_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_device_information_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Device information
        api_response = api_instance.api_v1_prism_device_information_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset, body=body)
...
> object api_v1_prism_export_post(body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Request category export
        api_response = api_instance.api_v1_prism_export_post(body=body)
...
> object api_v1_prism_filevault_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # FileVault
        api_response = api_instance.api_v1_prism_filevault_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_gatekeeper_and_xprotect_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Gatekeeper and XProtect
        api_response = api_instance.api_v1_prism_gatekeeper_and_xprotect_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_installed_profiles_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Installed profiles
        api_response = api_instance.api_v1_prism_installed_profiles_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_kernel_extensions_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Kernel Extensions
        api_response = api_instance.api_v1_prism_kernel_extensions_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_launch_agents_and_daemons_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Launch Agents and Daemons
        api_response = api_instance.api_v1_prism_launch_agents_and_daemons_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_local_users_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Local users
        api_response = api_instance.api_v1_prism_local_users_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_startup_settings_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Startup settings
        api_response = api_instance.api_v1_prism_startup_settings_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_system_extensions_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # System Extensions
        api_response = api_instance.api_v1_prism_system_extensions_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
> object api_v1_prism_transparency_database_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Transparency database
        api_response = api_instance.api_v1_prism_transparency_database_get(blueprint_ids=blueprint_ids, device_families=device_families, filter=filter, sort_by=sort_by, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tags
        api_response = api_instance.api_v1_tags_get(search)
        print("The response of DefaultApi->api_v1_tags_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->api_v1_tags_get: %s\n" % e)
```
...
# **api_v1_tags_post**
> object api_v1_tags_post(body=body)
...
> api_v1_tags_tag_id_delete(tag_id)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Tag
        api_instance.api_v1_tags_tag_id_delete(tag_id)
    except Exception as e:
...
> object api_v1_tags_tag_id_patch(tag_id, body=body)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Tag
        api_response = api_instance.api_v1_tags_tag_id_patch(tag_id, body=body)
...
> object api_v1_threat_details_get(classification=classification, date_range=date_range, device_id=device_id, status=status, sort_by=sort_by, term=term, limit=limit, offset=offset)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Threat Details
        api_response = api_instance.api_v1_threat_details_get(classification=classification, date_range=date_range, device_id=device_id, status=status, sort_by=sort_by, term=term, limit=limit, offset=offset)
...
# **api_v1_users_get**
> object api_v1_users_get(email=email, id=id, integration_id=integration_id, archived=archived)
...
with kandji_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Users
        api_response = api_instance.api_v1_users_get(email=email, id=id, integration_id=integration_id, archived=archived)
