...
> InlineObject19 get_activation_lock_bypass_code(device_id)
...
> InlineObject20 get_filevault_recovery_key(device_id)
...
> InlineObject22 get_recovery_lock_password(device_id)
...
# **get_unlock_pin**
> InlineObject21 get_unlock_pin(device_id)
