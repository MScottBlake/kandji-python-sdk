...
> Success200Response5 get_activation_lock_bypass_code(device_id)
...
> Success200Response6 get_filevault_recovery_key(device_id)
...
> Success200Response8 get_recovery_lock_password(device_id)
...
# **get_unlock_pin**
> Success200Response7 get_unlock_pin(device_id)
