...
class InHouseAppsApi:
    ...
    def _create_inhouse_app_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/library/ipa-apps',
    ...
    def _delete_inhouse_app_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/library/ipa-apps/{library_item_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_inhouse_apps(
        ...
        :param page: Optional page number. Used when results exceed pagination threshold. A hard upper <code>limit</code> is set at 300 app records returned per request.
        :type page: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _upload_inhouse_app_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/library/ipa-apps/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_inhouse_app_status(
        ...
        :param pending_upload_id: (required)
        :type pending_upload_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _upload_inhouse_app_status_serialize(
        ...
        if pending_upload_id is not None:
            _path_params['pending_upload_id'] = pending_upload_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/library/ipa-apps/upload/{pending_upload_id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
