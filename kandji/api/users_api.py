...
class UsersApi:
    ...
    def list_users(
        ...
        archived: Annotated[Optional[StrictStr], Field(description="Return only users that are either archived (true) or not archived (false). Archived users are users that appear in the Users module under the Archived tab.")] = None,
        ...
        :param archived: Return only users that are either archived (true) or not archived (false). Archived users are users that appear in the Users module under the Archived tab.
        :type archived: str
