...
class AutomatedDeviceEnrollmentIntegrationsListAdeDevices400Response(BaseModel):
    """
    AutomatedDeviceEnrollmentIntegrationsListAdeDevices400Response
    """ # noqa: E501
    dep_account: Optional[Any] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dep_account"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if dep_account (nullable) is None
        # and model_fields_set contains the field
        if self.dep_account is None and "dep_account" in self.model_fields_set:
            _dict['dep_account'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dep_account": obj.get("dep_account")
        })
