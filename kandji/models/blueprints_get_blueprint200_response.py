...
class BlueprintsGetBlueprint200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["color", "computers_count", "description", "enrollment_code", "icon", "id", "name", "params", "type"]
