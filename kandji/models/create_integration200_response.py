...
class CreateIntegration200Response(BaseModel):
    """
    CreateIntegration200Response
    """ # noqa: E501
    id: Optional[StrictStr] = None
    blueprint: Optional[CreateIntegration200ResponseBlueprint] = None
    ...
    defaults: Optional[CreateIntegration200ResponseDefaults] = None
    days_left: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    status_reason: Optional[Any] = None
    status_received_at: Optional[Any] = None
    device_counts: Optional[CreateIntegration200ResponseDeviceCounts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "blueprint": CreateIntegration200ResponseBlueprint.from_dict(obj["blueprint"]) if obj.get("blueprint") is not None else None,
            ...
            "defaults": CreateIntegration200ResponseDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None,
            "days_left": obj.get("days_left"),
            "status": obj.get("status"),
            "status_reason": obj.get("status_reason"),
            "status_received_at": obj.get("status_received_at"),
            "device_counts": CreateIntegration200ResponseDeviceCounts.from_dict(obj["device_counts"]) if obj.get("device_counts") is not None else None
        })
