...
class DeviceInformationGetDevice200Response(BaseModel):
    """
    ...
    full_software_version: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["agent_installed", "agent_version", "api_level", "asset_tag", "blueprint_id", "blueprint_name", "device_id", "device_name", "first_enrollment", "full_software_version", "is_missing", "is_removed", "last_check_in", "last_enrollment", "lost_mode_status", "mdm_enabled", "model", "os_version", "platform", "security_patch_level", "serial_number", "supplemental_build_version", "supplemental_os_version_extra", "tags", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "full_software_version": obj.get("full_software_version"),
