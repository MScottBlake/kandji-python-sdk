...
class DeviceInformationGetDeviceDetails200ResponseGeneral(BaseModel):
    """
    DeviceInformationGetDeviceDetails200ResponseGeneral
    """ # noqa: E501
    api_level: Optional[StrictStr] = None
    ...
    enterprise_device_id: Optional[StrictStr] = None
    ...
    os_build: Optional[StrictStr] = None
    os_version: Optional[StrictStr] = None
    platform: Optional[StrictStr] = None
    security_patch_level: Optional[StrictStr] = None
    serial_number: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["api_level", "asset_tag", "assigned_user", "blueprint_name", "blueprint_uuid", "device_id", "device_name", "enterprise_device_id", "enterprise_id", "first_enrollment", "last_enrollment", "manufacturer", "model_name", "os_build", "os_version", "platform", "security_patch_level", "serial_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enterprise_device_id": obj.get("enterprise_device_id"),
            ...
            "security_patch_level": obj.get("security_patch_level"),
