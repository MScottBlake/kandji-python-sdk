...
class DeviceInformationGetDeviceDetails200ResponseHardware(BaseModel):
    """
    DeviceInformationGetDeviceDetails200ResponseHardware
    """ # noqa: E501
    available_capacity: Optional[StrictStr] = None
    total_capacity: Optional[StrictStr] = None
    total_ram: Optional[StrictStr] = None
    wifi_mac_address: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["available_capacity", "total_capacity", "total_ram", "wifi_mac_address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "available_capacity": obj.get("available_capacity"),
            "total_capacity": obj.get("total_capacity"),
            "total_ram": obj.get("total_ram"),
            "wifi_mac_address": obj.get("wifi_mac_address")
        })
