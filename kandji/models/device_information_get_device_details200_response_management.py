...
class DeviceInformationGetDeviceDetails200ResponseManagement(BaseModel):
    """
    DeviceInformationGetDeviceDetails200ResponseManagement
    """ # noqa: E501
    management_mode: Optional[StrictStr] = None
    ownership: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["management_mode", "ownership"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceInformationGetDeviceDetails200ResponseManagement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceInformationGetDeviceDetails200ResponseManagement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "management_mode": obj.get("management_mode"),
