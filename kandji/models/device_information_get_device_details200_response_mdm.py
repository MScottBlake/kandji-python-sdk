...
class DeviceInformationGetDeviceDetails200ResponseMdm(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if mdm_enabled_user (nullable) is None
        # and model_fields_set contains the field
        if self.mdm_enabled_user is None and "mdm_enabled_user" in self.model_fields_set:
            _dict['mdm_enabled_user'] = None
