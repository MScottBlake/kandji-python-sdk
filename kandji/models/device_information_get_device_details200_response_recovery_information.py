...
class DeviceInformationGetDeviceDetails200ResponseRecoveryInformation(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if password_rotation_scheduled (nullable) is None
        # and model_fields_set contains the field
        if self.password_rotation_scheduled is None and "password_rotation_scheduled" in self.model_fields_set:
            _dict['password_rotation_scheduled'] = None
