...
class DeviceInformationGetDeviceLostModeDetails200Response(BaseModel):
    """
    DeviceInformationGetDeviceLostModeDetails200Response
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    lost_mode: Optional[DeviceInformationGetDeviceLostModeDetails200ResponseLostMode] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["device_id", "lost_mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lost_mode": DeviceInformationGetDeviceLostModeDetails200ResponseLostMode.from_dict(obj["lost_mode"]) if obj.get("lost_mode") is not None else None
        })
