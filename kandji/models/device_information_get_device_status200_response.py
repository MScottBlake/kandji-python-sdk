...
class DeviceInformationGetDeviceStatus200Response(BaseModel):
    """
    DeviceInformationGetDeviceStatus200Response
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    library_items: Optional[Any] = None
    parameters: Optional[Any] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["device_id", "library_items", "parameters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if library_items (nullable) is None
        # and model_fields_set contains the field
        if self.library_items is None and "library_items" in self.model_fields_set:
            _dict['library_items'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "library_items": obj.get("library_items"),
