...
class DeviceSecretsGetRecoveryLockPassword200Response(BaseModel):
    """
    DeviceSecretsGetRecoveryLockPassword200Response
    """ # noqa: E501
    recovery_password: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["recovery_password"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recovery_password": obj.get("recovery_password")
        })
