...
class GetDeviceActivity200Response(BaseModel):
    """
    GetDeviceActivity200Response
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    activity: Optional[GetDeviceActivity200ResponseActivity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activity": GetDeviceActivity200ResponseActivity.from_dict(obj["activity"]) if obj.get("activity") is not None else None
        })
