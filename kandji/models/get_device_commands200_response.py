...
class GetDeviceCommands200Response(BaseModel):
    """
    GetDeviceCommands200Response
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    commands: Optional[GetDeviceActivity200ResponseActivity] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "commands": GetDeviceActivity200ResponseActivity.from_dict(obj["commands"]) if obj.get("commands") is not None else None
        })
