...
class GetIpad200Response(BaseModel):
    """
    GetIpad200Response
    """ # noqa: E501
    ...
    user: Optional[GetIpad200ResponseUser] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": GetIpad200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
