...
class InlineObject10LostMode(BaseModel):
    """
    ...
    last_location: Optional[InlineObject10LostModeLastLocation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_location": InlineObject10LostModeLastLocation.from_dict(obj["last_location"]) if obj.get("last_location") is not None else None,
