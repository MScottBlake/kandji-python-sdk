...
class InlineObject37(BaseModel):
    """
    InlineObject37
    """ # noqa: E501
    ...
    integration: Optional[InlineObject37Integration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "id": obj.get("id"),
            "integration": InlineObject37Integration.from_dict(obj["integration"]) if obj.get("integration") is not None else None,
