...
class InlineObject4(BaseModel):
    ...
    mdm_device: Optional[InlineObject4MdmDevice] = None
    user_id: Optional[StrictStr] = None
    dep_account: Optional[InlineObject4DepAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mdm_device": InlineObject4MdmDevice.from_dict(obj["mdm_device"]) if obj.get("mdm_device") is not None else None,
            "user_id": obj.get("user_id"),
            "dep_account": InlineObject4DepAccount.from_dict(obj["dep_account"]) if obj.get("dep_account") is not None else None,
