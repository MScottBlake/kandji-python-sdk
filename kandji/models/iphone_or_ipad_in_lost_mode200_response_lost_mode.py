...
class IphoneOrIpadInLostMode200ResponseLostMode(BaseModel):
    """
    ...
    last_location: Optional[IphoneOrIpadInLostMode200ResponseLostModeLastLocation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_location": IphoneOrIpadInLostMode200ResponseLostModeLastLocation.from_dict(obj["last_location"]) if obj.get("last_location") is not None else None,
