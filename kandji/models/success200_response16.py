...
class Success200Response16(BaseModel):
    """
    ...
    integration: Optional[Success200Response16Integration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "id": obj.get("id"),
            "integration": Success200Response16Integration.from_dict(obj["integration"]) if obj.get("integration") is not None else None,
