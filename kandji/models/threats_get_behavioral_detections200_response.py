...
class ThreatsGetBehavioralDetections200Response(BaseModel):
    """
    ThreatsGetBehavioralDetections200Response
    """ # noqa: E501
    malicious_count: Optional[StrictInt] = None
    next: Optional[Any] = None
    previous: Optional[Any] = None
    results: Optional[Any] = None
    suspicious_count: Optional[StrictInt] = None
    total_count: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["malicious_count", "next", "previous", "results", "suspicious_count", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "malicious_count": obj.get("malicious_count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": obj.get("results"),
            "suspicious_count": obj.get("suspicious_count"),
