...
class TestDeviceInformationGetDeviceDetails200ResponseHardware(unittest.TestCase):
    """DeviceInformationGetDeviceDetails200ResponseHardware unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInformationGetDeviceDetails200ResponseHardware:
        """Test DeviceInformationGetDeviceDetails200ResponseHardware
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInformationGetDeviceDetails200ResponseHardware`
        """
        model = DeviceInformationGetDeviceDetails200ResponseHardware()
        if include_optional:
            return DeviceInformationGetDeviceDetails200ResponseHardware(
                available_capacity = '',
                total_capacity = '',
                total_ram = '',
                wifi_mac_address = ''
    ...
    def testDeviceInformationGetDeviceDetails200ResponseHardware(self):
        """Test DeviceInformationGetDeviceDetails200ResponseHardware"""
