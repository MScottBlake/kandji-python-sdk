...
class TestDeviceInformationGetDeviceDetails200ResponseManagement(unittest.TestCase):
    """DeviceInformationGetDeviceDetails200ResponseManagement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInformationGetDeviceDetails200ResponseManagement:
        """Test DeviceInformationGetDeviceDetails200ResponseManagement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInformationGetDeviceDetails200ResponseManagement`
        """
        model = DeviceInformationGetDeviceDetails200ResponseManagement()
        if include_optional:
            return DeviceInformationGetDeviceDetails200ResponseManagement(
                management_mode = '',
                ownership = ''
            )
        else:
    ...
    def testDeviceInformationGetDeviceDetails200ResponseManagement(self):
        """Test DeviceInformationGetDeviceDetails200ResponseManagement"""
