...
class TestDeviceInformationGetDeviceDetails200ResponseSecurity(unittest.TestCase):
    """DeviceInformationGetDeviceDetails200ResponseSecurity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInformationGetDeviceDetails200ResponseSecurity:
        """Test DeviceInformationGetDeviceDetails200ResponseSecurity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInformationGetDeviceDetails200ResponseSecurity`
        """
        model = DeviceInformationGetDeviceDetails200ResponseSecurity()
        if include_optional:
            return DeviceInformationGetDeviceDetails200ResponseSecurity(
                android_debug_bridge_enabled = None,
                developer_mode_enabled = None,
                device_posture = '',
                encryption_status = '',
                has_google_play_protect = 56,
                has_passcode = 56,
                is_encrypted = 56,
                unknown_app_sources_enabled = None
            )
        else:
            return DeviceInformationGetDeviceDetails200ResponseSecurity(
        )
    ...
    def testDeviceInformationGetDeviceDetails200ResponseSecurity(self):
        """Test DeviceInformationGetDeviceDetails200ResponseSecurity"""
