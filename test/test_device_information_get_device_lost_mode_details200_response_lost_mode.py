...
class TestDeviceInformationGetDeviceLostModeDetails200ResponseLostMode(unittest.TestCase):
    """DeviceInformationGetDeviceLostModeDetails200ResponseLostMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInformationGetDeviceLostModeDetails200ResponseLostMode:
        """Test DeviceInformationGetDeviceLostModeDetails200ResponseLostMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInformationGetDeviceLostModeDetails200ResponseLostMode`
        """
        model = DeviceInformationGetDeviceLostModeDetails200ResponseLostMode()
        if include_optional:
            return DeviceInformationGetDeviceLostModeDetails200ResponseLostMode(
                disable_status = '',
                disable_status_at = '',
                disabled_by = '',
                enable_status_at = '',
                enabled_by = '',
                last_location = kandji.models.device_information_get_device_lost_mode_details_200_response_lost_mode_last_location.deviceInformation_getDeviceLostModeDetails_200_response_lost_mode_last_location(
                    latitude = '', 
                    longitude = '', ),
                last_location_at = '',
    ...
    def testDeviceInformationGetDeviceLostModeDetails200ResponseLostMode(self):
        """Test DeviceInformationGetDeviceLostModeDetails200ResponseLostMode"""
