...
class TestDeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation(unittest.TestCase):
    """DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation:
        """Test DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation`
        """
        model = DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation()
        if include_optional:
            return DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation(
                latitude = '',
                longitude = ''
            )
        else:
    ...
    def testDeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation(self):
        """Test DeviceInformationGetDeviceLostModeDetails200ResponseLostModeLastLocation"""
