...
class TestInlineObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InlineObject:
        ...
        if include_optional:
            return InlineObject(
                id = '',
                blueprint = kandji.models.inline_object_blueprint.inline_object_blueprint(
                    id = '', 
                    name = '', 
                    icon = '', 
                    color = '', ),
                ...
                defaults = kandji.models.inline_object_defaults.inline_object_defaults(
                    email = '', 
                    phone = '', ),
                days_left = 56,
                status = '',
                ...
                device_counts = kandji.models.inline_object_device_counts.inline_object_device_counts(
                    total = 56, )
            )
        else:
            return InlineObject(
